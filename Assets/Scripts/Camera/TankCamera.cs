...
public class TankCamera : MonoBehaviour
{
    ...
    void Update(){
        ...
        var xQuat = Quaternion.AngleAxis(rotation.x + 180f, Vector3.up);

        transform.rotation = xQuat; //Quaternions seem to rotate more consistently than EulerAngles. Sensitivity seemed to change slightly at certain degrees using Euler. transform.localEulerAngles = new Vector3(-rotation.y, rotation.x, 0);
    }*/
	...
	*/
    ...
    void Update()
    {
	    character = GameObject.FindGameObjectWithTag("Player") as GameObject;
